...
void alltasks(tapa::istream<data_type>& a_q0,
          tapa::istream<data_type>& a_q1,
          tapa::istream<data_type>& b_q0,
          tapa::istream<data_type>& b_q1,
          tapa::ostream<data_type>& c_q0,
          tapa::ostream<data_type>& c_q1,
          uint64_t n_tiles) {
...
void VecAdd(tapa::mmap<bits<data_type_mmap>> vector_a,
  ...
  tapa::task()
    ...
    .invoke(alltasks, a_q0, a_q1, b_q0, b_q1, c_q0, c_q1, n_tiles);
